...
int main(int argc, char ** argv)
{
    ...
    int c1[1]={64};
    m.addStrategy(new treeLru(64, *new vector<int>(c1, c1+1)));
    int c20[2]={8, 8};
    m.addStrategy(new treeLru(64, *new vector<int>(c20, c20+2)));
    int c21[2]={16, 4};
    m.addStrategy(new treeLru(64, *new vector<int>(c21, c21+2)));
    int c2[2]={32, 2};
    m.addStrategy(new treeLru(64, *new vector<int>(c2, c2+2)));
    int c30[3]={8, 4, 2};
    m.addStrategy(new treeLru(64, *new vector<int>(c30, c30+3)));
    int c3[3]={4, 4, 4};
    m.addStrategy(new treeLru(64, *new vector<int>(c3, c3+3)));
    int c6[6]={2, 2, 2, 2, 2, 2};
    m.addStrategy(new treeLru(64, *new vector<int>(c6, c6+6)));
    ...
    int c1[1]={4096};
    m.addStrategy(new treeLru(4096, *new vector<int>(c1, c1+1)));
    int c2[2]={64, 64};
    m.addStrategy(new treeLru(4096, *new vector<int>(c2, c2+2)));
    int c3[3]={16, 16, 16};
    m.addStrategy(new treeLru(4096, *new vector<int>(c3, c3+3)));
    int c4[4]={8, 8, 8, 8};
    m.addStrategy(new treeLru(4096, *new vector<int>(c4, c4+4)));
